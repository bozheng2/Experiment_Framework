          ...
          <div className="col-md-6 col-md-offset-3">
                   ...
                   <div className="form-group">
                    ...
                    <div>
                      ...
                      <div>
                          <MoreLocationList location={this.state.newTriggerbylocation}/>
                          <MoreLocation addMoreLocation={(pointlat1, pointlng1, pointlat2, pointlng2) => {this.addMoreLocation(pointlat1, pointlng1, pointlat2, pointlng2)}}/>
                      </div>
